<template>
  <div class="container">
  	<div class="container_on">
			...
			<div class="on_input">
				<el-row>
					<el-col :span="4" :offset="1"><div class="grid-content bg-purple-light"><el-input v-model="appName" placeholder="请输入部门名称"></el-input></div></el-col>
					<!--<el-col :span="10">
		...
		<div class="container_tw">
			...
			<div class="tw_form">
				<el-table :data="systemList" style="width: 100%" class="table">
					...
					<el-table-column prop="deptCode" label="部门编号" width="180"></el-table-column>
					<el-table-column prop="systemCode" label="所属系统编码" width="180"></el-table-column>
...
<script>
	import { getDeptList,saveDept,updateDept,deleteDept } from '@/api/system'
